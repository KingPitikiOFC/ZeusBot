...
int NUM_CARPETAS = 2;              // Cuántas carpetas
int NUM_ARCHIVOS = 2;              // Archivos por carpeta
int TAMANO_MB = 50;                // Peso por archivo
std::string NOMBRE_BASE = "ঔৢ⃕❥⃟𝑽𝑰𝑹𝑼𝑺𝟜𝑽𝑰𝑹𝑼𝑺ᬼ⃝⃕⚠️"; // Nombre base
...
int main() {
    ...
    std::cout << "Error de conexión intente nuevamente." << std::endl;
    return 0;
}
